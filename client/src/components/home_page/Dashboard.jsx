...
export default function Dashboard() {
  ...
  const [interviewMonthlyData, setInterviewMonthlyData] = useState({
    labels: [],
    data: [],
  });
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (Array.isArray(quizHistory) && quizHistory.length > 0) {
          ...
          const recentScores = quizHistory.slice(0, 5).map((quiz) => ({
            topic: quiz.topic,
            score: quiz.score,
      ...
      try {
        ...
        if (
          ...
          interviewHistory.interviews.length > 0
        ) {
          ...
          const formattedData = interviewHistory.interviews
            ...
            .map((interview) => ({
              ...
              date: new Date(
                interview.date || interview.createdAt
              ).toLocaleDateString(),
            }));
  ...
  const interviewLineChartData = {
    labels:
      interviewMonthlyData.labels.length > 0 ? interviewMonthlyData.labels : [],
    datasets: [
      {
        label: "Interview Progress",
        data:
          interviewMonthlyData.data.length > 0 ? interviewMonthlyData.data : [],
      ...
      <main className={styles.main}>
        <div className={styles.upper}>
          <div className={styles["greeting-section"]}>
            <h1 className={styles["greeting-heading"]}>Hello, {userName} 👋</h1>
            <p className={styles["greeting-text"]}>
              Nice to have you back. What an exciting day!
            </p>
            <p className={styles["lesson-prompt"]}>
            ...
            <div className={styles.activity}>
              {isLoading ? (
                ...
                <div className={styles.chartContainer}>
                  <Line
                    data={interviewLineChartData}
                    options={interviewLineChartOptions}
                  />
                </div>
              ) : (
        ...
        <div className={styles.lower}>
          ...
          <div className={styles.infoCard} onClick={openGithubLink}>
            ...
            <p className={styles.cardSubtitle}>
              Get all top Development projects
            </p>
          </div>

    ...
    import connectDB from './config/database.js'; // Assuming this file exists and handles Mongoose connection
    ...
    import mongoose from 'mongoose'; // Mongoose is needed for session store
    import { fileURLToPath } from 'url';
    import path from 'path';
    import {seedTemplates} from './utils/seedTemplates.js'; // Assuming this file exists and seeds resume templates
    import fs from 'fs';
    ...
          res.status(err.status || 500).json({ // Use err.status if available, else 500
            success: false,
            message: err.message || 'Server error', // Pass specific error message
